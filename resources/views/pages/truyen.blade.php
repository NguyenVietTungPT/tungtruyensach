    ...
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ url('danh-muc/' . $truyen->danhmuctruyen->slug_danhmuc) }}">
                    {{ $truyen->danhmuctruyen->tendanhmuc }} </a></li>
                        ...
                        @if (Auth::user() && isset($chapter_moinhat->truyen_id))
                            @if (!$favorite)
                                <li>
                                    <div class="row">
                                        <div class="col-sm">
                                            <a href="{{ url('yeu-thich/' . $truyen->slug_truyen . '/' . $chapter_moinhat->truyen_id) }}"
                                                class="btn mt-2 btn-xemtruyen btn-success mb-2">
                                                Theo dõi
                                            </a>
                                        </div>
                                        @if (!$lock)
                            ...
                            @else
                                <li>
                                    <a href="{{ url('huy-bo/' . $truyen->slug_truyen . '/' . $chapter_moinhat->truyen_id) }}"
                                        class="btn mt-2 btn-xemtruyen btn-danger mb-2">
                                        Bỏ theo dõi
                                    </a>
                                </li>
                            @endif
                        ...
                        @if ($chapter_dau && $lock)
                            ...
                            <li>
                                <a href="{{ url('xem-chapter/' . $chapter_moinhat->slug_chapter) }}"
                                    class="btn btn-success mt-2 btn-xemtruyen">
                                    Đọc chương mới nhất
                                </a>
                            </li>
                        @else
