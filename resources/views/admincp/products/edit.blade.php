...
@section('content')
  <div class="container-fluid">
      <div class="col-md-10" style="margin-left: 250px">
        <form class="needs-validation" novalidate method="POST" action="{{ route('products.update', [$product->id]) }}" enctype="multipart/form-data">
          @method('PUT') 
          @csrf  
          <div class="form-row">
            <div class="col-md-6 mb-3">
              <label for="validationCustom03">Tên Mặt Hàng</label>
              <input type="text" class="form-control" id="validationCustom03" value="{{ $product->pro_name }}" name="pro_name" required>
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control" id="validationCustom03" value="{{ $product->pro_price }}" name="pro_price" required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control" id="validationCustom03" value="{{ $product->pro_price_entry }}" name="pro_price_entry" required>
              <div class="invalid-feedback">
            ...
            <div class="col-md-3 mb-3">
              ...
              <input type="text" class="form-control" id="validationCustom03" value="{{ $product->pro_number }}" name="pro_number" required>
              <div class="invalid-feedback">
          ...
          <div class="form-group">
            ...
            <img src="{{ asset('public/uploads/sach/' . $product->pro_img) }}" height="250" width="180">
          </div>
          <div class="form-group">
            <label for="exampleInputEmail1">Mô tả Mặt hàng</label>
            <textarea class="form-control" rows="5" style="resize: none" value="{{ $product->pro_description }}" name="pro_description"> </textarea>
          </div>
